...
# save results 
save.image(file = "./output/Sim1/sim1_simModel_deconvolution_crossPlatform.RData")
save(list = ls(pattern = "estW"), file = "./output/Sim1/simModel/sim1_simModel_estW.RData")
